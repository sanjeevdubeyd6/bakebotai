...
export default function Funnels() {
    ...
    React.useEffect(() => {
        ...
        setMessages([
            ...
            My first request is to build an eCommerce sales funnel for the following product or service: ${inputOne} targeting the following audience: ${inputTwo} such as budget:${inputThree}, goals:${inputFour}.
            Use markdown Format
            Respond in English.
            Greet users by saying, "I've baked your request just for you...Here it is"" Illustrate the funnel using ASCII art"
            ...
            {showInput ? <div className='flex flex-col w-full'>
                <div className='flex flex-col w-full mt-8 space-y-6 h-full'>
                    <div className='flex flex-col w-full space-y-1'>
                        <label className='text-gray-600 font-medium'>What is your product or service? </label>
                        <input onChange={(e) => setInputFour(e.target.value)} className='w-full h-12 px-4 rounded-lg border-2 border-gray-300 text-lg focus:outline-none focus:border-brand' type='text' />
                    </div>
                    <div className='flex flex-col w-full space-y-1'>
                        <label className='text-gray-600 font-medium'>What is your target audience? (i.e. Cannabis Smokers)</label>
                    ...
                    <div className='flex flex-col md:flex-row w-full space-y-4 md:space-y-0 md:space-x-5'>
                        <div className='flex flex-col w-full space-y-1'>
                            <label className='text-gray-600 font-medium'>What is your budget? (i.e. $5000)</label>
                        ...
                        <div className='flex flex-col w-full space-y-1'>
                            <label className='text-gray-600 font-medium'>What is the goal? (More Sales)</label>
